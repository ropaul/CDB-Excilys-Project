					...
					<form action="addComputer" method="POST">
						<fieldset>
							<div class="form-group">
								...
								<input type="text" class="form-control" id="name" name="name" value="${param.name}" placeholder="name" "> 
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" id="discontinued" name="discontinued" value="${param.discontinued}"
