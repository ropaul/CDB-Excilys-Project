			...
			<div id="actions" class="form-horizontal">
				<div class="pull-left">
					<form id="searchForm" action="#" method="GET" class="form-inline">
						<input type="search" id="searchbox" name="search"
							class="form-control" placeholder="Search name" value="${seach}" />
						<a id="search" href="dashboard"><input type="submit"
				...
				<div class="pull-right">
					<a class="btn btn-success" id="addComputer" href="addComputer"><spring:message
							code="dashboard.add" /> <spring:message
							code="dashboard.computer" /></a> <a class="btn btn-default"
					...
					<c:forEach var="computer" items="${computers}">
						<tr>
							...
							<td class="editMode" style="width: 60px; height: 22px;"><span
								style="vertical-align: top;"><a href="delete"
									id="deleteSelectedCompany"
									onclick="$.fn.deleteSelectedCompany();"> <i
										class="fa fa-trash-o fa-lg"><input type="hidden"
											name="cbcompany" class="cbcompany"
											value="${computer.company.id}"></i></a></span></td>
						</tr>
					</c:forEach>
	...
	<footer class="navbar-fixed-bottom">
		<div class="container text-center">
			<ul class="pagination">
				<c:choose>
					<c:when test="${numeropage >= 3 }">
						...
						<li><a href="dashboard?page=${numeropage -2 }">
								${numeropage -1 }</a></li>
			...
			<div class="btn-group btn-group-sm pull-right" role="group">
				<a href="dashboard?perpage=10">
					<button type="button" onclick="dashboard?perpage=50"
						class="btn btn-default">10</button>
				</a> <a href="dashboard?perpage=50">
					<button type="button" onclick="dashboard?perpage=50"
						class="btn btn-default">50</button>
				</a> <a href="dashboard?perpage=100"><button type="button"
						onclick="dashboard?perpage=100" class="btn btn-default">100</button>
				</a>
			</div>
	</footer>
