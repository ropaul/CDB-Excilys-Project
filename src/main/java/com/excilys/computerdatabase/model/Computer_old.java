...
@Table (name= "computer" )
public class Computer_old implements Serializable{
...
//	 */
	...
	public Computer_old(long id, String name, Company companie, Date introduced, Date discotinued) {
		super();
		this.id = id;
		this.name = name;
	...
	public Computer_old( String name, Company companie, Date introduced, Date discotinued) {
		this.id = 0;
		this.name = name;
		this.company = companie;
		this.introduced = introduced;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Computer_old other = (Computer_old) obj;
		if (company == null) {
